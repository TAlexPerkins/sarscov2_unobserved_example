...
//
//     // draw number of offspring from each case (parent)
//     Rprintf(" *** calling realloc with 'number_offspring' *** \n");
//     number_offspring = realloc(number_offspring, parents * sizeof(int));
//     int tot_offspring = 0;
//     for(int i=0; i<parents; i++){
//       double R0;
//       double u = unif_rand();
...
//       -------------------------------------------------------------------------------- */
//
//       Rprintf(" *** calling realloc with 'time_exp_next' *** \n");
//       time_exp_next = realloc(time_exp_next,tot_offspring * sizeof(double));
//
//       int k=0;
//       for(int i=0; i<parents; i++){
//         // only for parents with offspring
...
//       -------------------------------------------------------------------------------- */
//
//       Rprintf(" *** calling realloc with 'incubation_periods' *** \n");
//       incubation_periods = realloc(incubation_periods,parents * sizeof(double));
//       for(int i=0; i<parents; i++){
//         incubation_periods[i] = rweibull(inc_shape,inc_scale);
//       }
//
...
//       -------------------------------------------------------------------------------- */
//
//       Rprintf(" *** calling realloc with 'time_det' *** \n");
//       time_det = realloc(time_det,parents * sizeof(double));
//
//       k=0;
//       for(int i=0; i<parents; i++){
//         double time_det_indiv = time_exp[i] + incubation_periods[i] + (double)rpois(report_delay_rate);
...
//       -------------------------------------------------------------------------------- */
//
//       Rprintf(" *** calling realloc with 'time_death' *** \n");
//       time_death = realloc(time_death,parents * sizeof(double));
//
//       k=0;
//       for(int i=0; i<parents; i++){
//         double time_death_indiv = time_exp[i] + incubation_periods[i] + rlnorm(symp_to_death_meanlog,symp_to_death_sdlog);
...
//       -------------------------------------------------------------------------------- */
//
//       Rprintf(" *** calling realloc with 'time_exp_floor' *** \n");
//       time_exp_floor = realloc(time_exp_floor,parents * sizeof(int));
//       for(int i=0; i<parents; i++){
//         time_exp_floor[i] = (int)floor(time_exp[i]);
//       }
//
//       Rprintf(" *** calling realloc with 'time_exp_uniq' *** \n");
//       time_exp_uniq = realloc(time_exp_uniq, parents * sizeof(int));
//       Rprintf(" *** calling realloc with 'time_exp_dup' *** \n");
//       time_exp_dup = realloc(time_exp_dup, parents * sizeof(int));
//       int j, n, flag;
//
//       time_exp_uniq[0] = time_exp_floor[0];
//       int count_exp = 1;
...
//       -------------------------------------------------------------------------------- */
//
//       Rprintf(" *** calling realloc with 'time_det_floor' *** \n");
//       time_det_floor = realloc(time_det_floor,time_det_k * sizeof(int));
//       for(int i=0; i<time_det_k; i++){
//         time_det_floor[i] = (int)floor(time_det[i]);
//       }
//
//       Rprintf(" *** calling realloc with 'time_det_uniq' *** \n");
//       time_det_uniq = realloc(time_det_uniq, time_det_k * sizeof(int));
//       Rprintf(" *** calling realloc with 'time_det_dup' *** \n");
//       time_det_dup = realloc(time_det_dup, time_det_k * sizeof(int));
//
//       time_det_uniq[0] = time_det_floor[0];
//       int count_det = 1;
//
...
//       -------------------------------------------------------------------------------- */
//
//       Rprintf(" *** calling realloc with 'time_death_floor' *** \n");
//       time_death_floor = realloc(time_death_floor,time_death_k * sizeof(int));
//       for(int i=0; i<time_death_k; i++){
//         time_death_floor[i] = (int)floor(time_death[i]);
//       }
//
//       Rprintf(" *** calling realloc with 'time_death_uniq' *** \n");
//       time_death_uniq = realloc(time_death_uniq, time_death_k * sizeof(int));
//       Rprintf(" *** calling realloc with 'time_death_dup' *** \n");
//       time_death_dup = realloc(time_death_dup, time_death_k * sizeof(int));
//
//       time_death_uniq[0] = time_death_floor[0];
//       int count_death = 1;
//
